...
/**
 * Dry-run overlay for EdgeCrafter (ECPose) keypoints + skeleton. This is NOT the
 ...
 * informational — never enters the risk engine.
 */
export function BackendPoseOverlay({ poses }: { poses: BackendPose[] }) {
